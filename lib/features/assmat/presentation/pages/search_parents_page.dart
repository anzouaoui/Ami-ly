...
const _families = [
  _FamilyData(
    ...
    scheduleType: 'Temps complet',
    schedule: 'Lundi au Vendredi, 8h - 18h',
    avatarColor: Color(0xFFFFCCBC),
    tags: ['Non fumeur', 'PSC1 souhaité', 'Jardin ou espace extérieur'],
    kids: [
      _ChildData(
        firstName: 'Lucas',
        age: '2 ans',
        interests: ['Peinture', 'Jeux de construction', 'Parc'],
      ),
      _ChildData(
        firstName: 'Chloé',
        age: '6 mois',
        interests: ['Comptines', 'Éveil sensoriel'],
      ),
    ],
    quote:
        '"Nous recherchons un environnement chaleureux et stimulant avec des activités d\'éveil variées."',
  ),
  _FamilyData(
    ...
    schedule: 'Mardi au Jeudi, 9h - 17h',
    avatarColor: Color(0xFFB2DFDB),
    tags: ['Non fumeur', 'Animaux acceptés'],
    kids: [
      _ChildData(
        firstName: 'Emma',
        age: '18 mois',
        interests: ['Musique', 'Lecture', 'Activités extérieures'],
      ),
      _ChildData(
        firstName: 'Noah',
        age: '4 ans',
        interests: ['Dessin', 'Sport'],
      ),
    ],
    quote: '"Nous cherchons une assistante maternelle bienveillante et dynamique pour nos deux enfants."',
  ),
  _FamilyData(
    displayName: 'Camille L.',
    initials: 'CL',
    city: 'Issy-les-Moulineaux',
    startDate: 'Novembre 2025',
    scheduleType: 'Temps complet',
    schedule: 'Lundi au Vendredi, 7h30 - 18h30',
    avatarColor: Color(0xFFD1C4E9),
    tags: ['CMG CAF', 'PSC1 souhaité', 'Non fumeur'],
    kids: [
      _ChildData(
        firstName: 'Léa',
        age: '14 mois',
        interests: ['Éveil musical', 'Marionnettes'],
      ),
    ],
  ),
  _FamilyData(
    ...
    scheduleType: 'Temps complet',
    schedule: 'Lundi au Vendredi, 8h - 17h',
